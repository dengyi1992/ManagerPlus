...
public class CardBigUserGvItemAdapter extends BaseAdapter {
    ...
    public CardBigUserGvItemAdapter(Context context, List<clientUserBean.SuccessBean> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.card_big_user_gv_item, null);
